...
export default function ComponentSlider() {
  ...
  const [rv, toggleR] = useToggle(
    ['0', '1', '2', '3', '4', '5', '6', '7'],
    'random',
  );
  const [fv, toggleF] = useToggle(
    ['0', '1', '2', '3', '4', '5', '6', '7'],
    'forward',
  );
  const [rev, toggleRE] = useToggle(
    ['0', '1', '2', '3', '4', '5', '6', '7'],
    'reverse',
  );
  ...
  return (
    <ComponentPage>
      ...
      <Playground>
        ...
        <div>
          <span>random toggle: </span>
          {rv}
        </div>
        <div>
          <span>forward toggle: </span>
          {fv}
        </div>
        <div>
          <span>reverse toggle: </span>
          {rev}
        </div>
        <div>
          <span>specific toggle: </span>
          {fv}
        </div>
