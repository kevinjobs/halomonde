...
export { default as BanPage } from './BanPage';
export type { BanPageProps } from './BanPage';
export { default as LeftMenu } from './Menu';
export type { LeftMenuItem as SubMenuProps } from './Menu';
...
export { default as EditPanel, type EditPanelProps } from './edit-panel';
